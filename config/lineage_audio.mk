...
ALARM_PATH := vendor/matrixx/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/matrixx/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/matrixx/prebuilt/common/media/audio/ringtones
